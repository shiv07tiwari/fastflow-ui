...
import {MdPlayArrow, MdReplay, MdAdd, MdZoomIn, MdZoomOut, MdCheck, MdEdit} from 'react-icons/md';
...
const Header: React.FC<{
    ...
    return (
        <header className="shadow-sm py-2 px-4" style={{backgroundColor: "#FFFFFF"}}>
                ...
                <div className="d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center">
                        {isEditing ? (
                            ...
                            <h1 className="h4 mb-0 me-2">{name}</h1>
                        )}
                        <button
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <HeaderButton onClick={onZoomIn} icon={<MdZoomIn size={20}/>} label="Zoom In"/>
                        <HeaderButton onClick={onZoomOut} icon={<MdZoomOut size={20}/>} label="Zoom Out"/>
                    </div>
                </div>
            </div>
        </header>
